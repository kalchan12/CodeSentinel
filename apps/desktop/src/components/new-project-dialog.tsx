          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input
                ...
                className="bg-background border border-outline-variant rounded-lg px-3.5 py-2 text-sm text-on-background placeholder:text-on-surface-variant/60 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-[JetBrains_Mono]"
              />
            </div>
